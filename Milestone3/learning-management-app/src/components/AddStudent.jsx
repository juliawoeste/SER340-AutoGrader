      ...
      <div>
        ...
        <form>
          <div className="form-group" style={{paddingBottom: "2rem"}}>
            ...
            <label for="name" style={{paddingTop: "2rem"}}>Student Name</label>
            <input
              type="text"
              ...
              style={{width: "15rem"}}
            />
            <label for="email" style={{paddingTop: "2rem"}}>Student Email</label>
            <input
              type="text"
              className="form-control"
              id="exampleInputEmail1"
              ...
              style={{width: "15rem"}}
            />
            <label for="password" style={{paddingTop: "2rem"}}>Student Password</label>
            <input
              type="text"
              className="form-control"
              id="exampleInputEmail1"
